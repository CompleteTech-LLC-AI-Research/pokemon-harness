...
The preceding repository tip was `cec560e`, merged through PR
...
without changing the acceptance result or promoting the release status. This
README clarification is also documentation-only.

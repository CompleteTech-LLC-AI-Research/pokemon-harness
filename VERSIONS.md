...
harness-local divergence revision `7ecd4b73db822340467a28796b39504aad8d66c5`
...
| PyBoy | `2.7.0` + fork `7ecd4b73db822340467a28796b39504aad8d66c5` | `vendor/pyboy-src/POKERED_HARNESS_PYBOY_REVISION` and `vendor/pyboy-src/pyboy/__init__.py` (harness-local divergence revision; pre-divergence harness fork revision `c565df66c3731fad2856169a90f6bbec99925915`) |

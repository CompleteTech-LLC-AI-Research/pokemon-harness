...
def _sessions():
    ...
    for emulator in (primary_pb, peer_pb):
        ...
        emulator.mb = clock_shell.mb
        emulator.events = clock_shell.events
        emulator.frame_count = 0
        emulator._handle_events = clock_shell._handle_events
        emulator._post_handle_events = clock_shell._post_handle_events
        emulator._handle_hooks = clock_shell._handle_hooks

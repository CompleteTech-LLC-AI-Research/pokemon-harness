...
# Exactly the module-level names that the original single-module version defined here.
# An explicit __all__ (rather than a bare star export) keeps `Enum` itself from leaking
# into the importing module: under Cython that leak collides with the C type `Enum`
# and aborts `import pyboy` with "Cannot overwrite C type Enum".
__all__ = [
    "ADDR_BALLS_LEFT",
    "ADDR_BALL_SAVER_SECONDS_LEFT",
    "ADDR_BALL_SIZE",
    "ADDR_BALL_TYPE",
    "ADDR_BALL_X",
    "ADDR_BALL_X_VELOCITY",
    "ADDR_BALL_Y",
    "ADDR_BALL_Y_VELOCITY",
    "ADDR_BONUS_STAGE_WON",
    "ADDR_CURRENT_MAP",
    "ADDR_CURRENT_SLOT_FRAME",
    "ADDR_CURRENT_STAGE",
    "ADDR_CURRENT_STAGE_BACKUP",
    "ADDR_D5C6",
    "ADDR_D580",
    "ADDR_EXTRA_BALLS",
    "ADDR_GAME_OVER",
    "ADDR_LEFT_MAP_MOVE_COUNTER",
    "ADDR_MESSAGE_BUFFER",
    "ADDR_MULTIPLIER",
    "ADDR_NUM_BALL_LIVES",
    "ADDR_NUM_CATCH_TILES_FLIPPED",
    "ADDR_NUM_MON_HITS",
    "ADDR_PIKACHU_SAVER_CHARGE",
    "ADDR_POKEDEX",
    "ADDR_POKEMON_TO_CATCH",
    "ADDR_RARE_POKEMON_FLAG",
    "ADDR_RIGHT_MAP_MOVE_COUNTER",
    "ADDR_SCORE",
    "ADDR_SPECIAL_MODE",
    "ADDR_SPECIAL_MODE_ACTIVE",
    "ADDR_SPECIAL_MODE_STATE",
    "ADDR_STAGE_COLLISION_STATE",
    "ADDR_STAGE_COLLISION_STATE_HELPER",
    "ADDR_TILE_ILLUMINATION",
    "ADDR_TIMER_ACTIVE",
    "ADDR_TIMER_FRAMES",
    "ADDR_TIMER_MINUTES",
    "ADDR_TIMER_PAUSED",
    "ADDR_TIMER_RAN_OUT",
    "ADDR_TIMER_SECONDS",
    "ADDR_TO_NO_OP_BANK_STAGE_OVERRIDE",
    "ADDR_TO_NO_OP_STAGE_OVERRIDE",
    "ADDR_WHICH_DIGLETT",
    "BANK_OFFSET_ADD_CAUGHT_POKEMON_TO_PARTY",
    "BANK_OFFSET_ADD_EXTRA_BALL",
    "BANK_OFFSET_BALL_SAVED_BLUE",
    "BANK_OFFSET_BALL_SAVED_RED",
    "BANK_OFFSET_BALL_UPGRADE_TRIGGER_BLUE_FIELD",
    "BANK_OFFSET_BALL_UPGRADE_TRIGGER_RED_FIELD",
    "BANK_OFFSET_COMPLETE_EVOLUTION_MODE_BLUE_FIELD",
    "BANK_OFFSET_COMPLETE_EVOLUTION_MODE_RED_FIELD",
    "BANK_OFFSET_DIGLETT_STAGE_COMPLETE",
    "BANK_OFFSET_DISABLE_TIMER",
    "BANK_OFFSET_FAIL_EVOLUTION_MODE_BLUE_FIELD",
    "BANK_OFFSET_FAIL_EVOLUTION_MODE_RED_FIELD",
    "BANK_OFFSET_GENGAR_STAGE_COMPLETE",
    "BANK_OFFSET_INIT_DIGLETT_BONUS_STAGE",
    "BANK_OFFSET_INIT_GENGAR_BONUS_STAGE",
    "BANK_OFFSET_INIT_MEOWTH_BONUS_STAGE",
    "BANK_OFFSET_INIT_MEWTWO_BONUS_STAGE",
    "BANK_OFFSET_INIT_SEEL_BONUS_STAGE",
    "BANK_OFFSET_MAP_CHANGE_ATTEMPT",
    "BANK_OFFSET_MAP_CHANGE_SUCCESS",
    "BANK_OFFSET_MEOWTH_STAGE_COMPLETE",
    "BANK_OFFSET_MEWTWO_STAGE_COMPLETE",
    "BANK_OFFSET_OPENED_SLOT_BY_GETTING_4_CAVE_LIGHTS_BLUE",
    "BANK_OFFSET_OPENED_SLOT_BY_GETTING_4_CAVE_LIGHTS_RED",
    "BANK_OFFSET_PAUSE_METHOD_BANK",
    "BANK_OFFSET_PAUSE_METHOD_CALL",
    "BANK_OFFSET_PIKA_SAVER_INCREMENT_BLUE_FIELD",
    "BANK_OFFSET_PIKA_SAVER_INCREMENT_RED_FIELD",
    "BANK_OFFSET_PIKA_SAVER_USED_BLUE_FIELD",
    "BANK_OFFSET_PIKA_SAVER_USED_RED_FIELD",
    "BANK_OFFSET_SEEL_STAGE_COMPLETE",
    "BANK_OFFSET_SET_POKEMON_SEEN_FLAG",
    "BANK_OFFSET_SLOT_REWARD_EXTRA_BALL",
    "BANK_OFFSET_SLOT_REWARD_ROULETTE",
    "BANK_OFFSET_START_EVOLUTION",
    "CURRENT_SLOT_FRAME_VALUE",
    "MAX_SCORE",
    "MESSAGE_BUFFER_BYTE_WIDTH",
    "NO_OP_BYTE_WIDTH_STAGE_OVERRIDE",
    "PIKACHU_SAVER_CHARGE_MAX",
    "SCORE_BYTE_WIDTH",
    "TILE_ILLUMINATION_BYTE_WIDTH",

...
cdef class PyBoy:
    ...
    cpdef void _handle_events(self, list) noexcept with gil  # cpdef: harness LockstepCoordinator calls this
    ...
    cpdef void _post_handle_events(self) noexcept with gil  # cpdef: harness LockstepCoordinator calls this
